...
export default appSchema({
    ...
    tables: [
        tableSchema({
            name: "routine",
            columns: [
                { name: "routineid", type: "number", isIndexed: true },
        ...
        tableSchema({
            name: "routineday",
            columns: [
                { name: "routinedayid", type: "number", isIndexed: true },
                { name: "routineday", type: "string" },
                { name: "routine_id", type: "number", isIndexed: true }, // Foreign key to Routine
            ],
        }),
        tableSchema({
            name: "routinedexercise",
            columns: [
                { name: "exerciseid", type: "number", isIndexed: true },
                { name: "exercisename", type: "string" },
                { name: "sets", type: "number" },
                { name: "reps", type: "number" },
                { name: "routineday_id", type: "number", isIndexed: true }, // Foreign key to RoutinedDay
            ],
        }),
        tableSchema({
            name: "preformedset",
